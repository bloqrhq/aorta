      ...
      <div className="w-full max-w-md space-y-8 bg-white dark:bg-slate-900 p-10 rounded-2xl shadow-xl border border-divider/50 dark:border-slate-800 transition-colors duration-200">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-slate-medium dark:text-slate-400 text-center">
            Join Aorta and start your journey today
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-slate-dark dark:text-slate-300 mb-1.5">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-slate-dark dark:text-slate-300 mb-1.5">
                Confirm Password
              </label>
              <div className="relative">
                <input
                  ...
                  className={`appearance-none block w-full px-4 py-3 border rounded-lg placeholder-slate-400 focus:outline-none focus:ring-2 transition-all sm:text-sm bg-clinical/30 dark:bg-slate-950 dark:text-white pr-10 ${confirmPassword && password !== confirmPassword
                      ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20'
                      : 'border-slate-medium/30 dark:border-slate-700 focus:ring-primary/20 focus:border-primary'
                    }`}
                  placeholder="••••••••"
                />
                <button
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-slate-medium dark:text-slate-400">
            ...
            <Link to="/signin" className="font-semibold text-primary dark:text-purple-400 hover:text-primary/80 dark:hover:text-purple-300 hover:underline transition-colors">
              Sign in
            </Link>
          </p>
        </div>
